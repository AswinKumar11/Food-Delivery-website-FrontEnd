...
const cloudinaryImageIdURL = "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/";
const Card = (props) => {
  const { name, cuisines, costForTwoString, cloudinaryImageId } =
    props?.resData;
  return (
    <div className="card">
      <img
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        {restrauntData.map((resData) => (
          <Card resData={resData.data} key={resData?.data?.id}/>
        ))}
      </div>
    </div>
  );
